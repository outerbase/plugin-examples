 ...
 *  ░░░░░░░░░░░░░░░░░
 * 
 * Define your custom classes here. We do recommend the usage of our `OuterbasePluginConfig_$PLUGIN_ID_COLUMN`
 ...
 * TBD
 */
var templateCell_$PLUGIN_ID_COLUMN = document.createElement('template')
...
class OuterbasePluginCell_$PLUGIN_ID_COLUMN extends HTMLElement {
    ...
    constructor() {
        ...
        this.shadow.appendChild(templateCell_$PLUGIN_ID_COLUMN.content.cloneNode(true))
    }
    
    connectedCallback() {
        this.config = new OuterbasePluginConfig_$PLUGIN_ID_COLUMN(decodeAttributeByName(this, "configuration"))
        this.render()
    }
 ...
 */
var templateEditor_$PLUGIN_ID_COLUMN = document.createElement("template")
...
class OuterbasePluginCellEditor_$PLUGIN_ID_COLUMN extends HTMLElement {
    ...
    constructor() {
        ...
        this.shadow = this.attachShadow({ mode: "open" })
        this.shadow.appendChild(templateEditor_$PLUGIN_ID_COLUMN.content.cloneNode(true))
    }
...
window.customElements.define('outerbase-plugin-cell', OuterbasePluginCell_$PLUGIN_ID_COLUMN)
window.customElements.define('outerbase-plugin-cell-editor', OuterbasePluginCellEditor_$PLUGIN_ID_COLUMN)
window.customElements.define('outerbase-plugin-configuration', OuterbasePluginConfiguration_$PLUGIN_ID_COLUMN)
